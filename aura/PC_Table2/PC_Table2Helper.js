({
    ...
    initializeColumnMetaData : function(component) {
        ...
        action.setParams({
            ...
            field_names: component.get('v.FieldNamesToShowInTable'),
            //field_labelToShow: component.get('v.FieldNamesToShowInTable'),
        ...
        action.setCallback(this, function(response){
            ...
            if(state === 'SUCCESS'){
                ...
                if(column_metadata_wrapper.error_message){
                    ...
                    let field_names = component.get('v.FieldNamesToShowInTable');
